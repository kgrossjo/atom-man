...
export default class ManOutputEditor {
    ...
    pageDown() {
        const buf = this.editor.displayBuffer;
        const pageSize = buf.rowsPerPage;
    ...
    scrollDown() {
        ...
        this.editor.scrollToBufferPosition(new Point(firstRow + pageSize, 0));
    }
    ...
    scrollUp() {
        ...
        const pageSize = buffer.rowsPerPage;
        const firstRow = buffer.firstVisibleScreenRow;
        this.editor.scrollToBufferPosition(new Point(firstRow - 1, 0));
    }
